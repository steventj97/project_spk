  	...
  	<div class="content">
       ...
       @csrf
  		  <div class="form-group">
  			...
  			<input class="form-control" type="text" placeholder="jenis kriteria" name="jenis_kriteria"> 
  		  </div>
  		  <div class="form-group">
  		    <label for="exampleInputEmail1">Bobot Kriteria</label>
  			<input class="form-control" type="text" placeholder="bobot kriteria" name="bobot_kriteria">
  		  </div>
